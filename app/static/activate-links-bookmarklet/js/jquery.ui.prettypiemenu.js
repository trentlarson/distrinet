...
$.widget("ui.prettypiemenu", {
	options: {
	    ...
	    centerIconInActive: "./static/activate-links-bookmarklet/images/45_red.gif",
	    centerIconActive: "./static/activate-links-bookmarklet-bookmarklet/images/45_green.gif",
